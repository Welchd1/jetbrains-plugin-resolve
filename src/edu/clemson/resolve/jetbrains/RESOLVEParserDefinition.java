...
public class RESOLVEParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(BY, CART_PROD, CHANGING, CONCEPT, CONSTRAINTS,
            CONVENTIONS, CORRESPONDENCE, CHAINABLE, DECREASING, DEFINITION, DO, ELSE, END, ENSURES,
            ENHANCEMENT, EXEMPLAR, EXISTS, VALUED,
            ...
            PROCEDURE, PROG_IF, RECORD, RECURSIVE, RECOGNITION, REQUIRES, THEN, USES, VAR, WHICH_ENTAILS, WHILE, CATEGORICAL,
